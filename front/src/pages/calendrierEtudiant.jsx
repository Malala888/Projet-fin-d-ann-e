...
const CalendrierEtudiant = () => {
    ...
    const fetchEvents = async (etudiantId) => {
        try {
            ...
            const response = await axios.get(`http://localhost:5000/etudiants/${etudiantId}/calendrier`);
        ...
        <div className="bg-gray-50 font-sans min-h-screen flex flex-col">
            ...
            <div className="flex flex-1">
                ...
                <main className="flex-1 p-8 overflow-y-auto">
                    <h1 data-aos="fade-down" className="text-3xl font-bold text-gray-800 mb-6">
                        Calendrier des Échéances
                    </h1>

                    <div className="flex flex-col lg:flex-row gap-6">
                        {/* Section Calendrier */}
                        <div data-aos="fade-right" className="bg-white p-6 rounded-lg shadow-xl flex-1 min-h-[600px] border border-gray-200">
                            <FullCalendar
                        ...
                        <div data-aos="fade-left" className="w-full lg:w-80 bg-white p-6 rounded-lg shadow-xl border border-gray-200 h-fit">
                                            ...
                                            >
                                                ...
                                                <div className="ml-3 flex-1">
                                                    ...
                                                    <p className={`text-xs text-${color}-600 font-semibold mt-0.5`}>
                                                        ...
                                                        {new Date(event.start).toLocaleDateString('fr-FR', { day: 'numeric', month: 'long', year: 'numeric' })}
                                                    </p>
                                                </div>
                                                <span className={`ml-2 px-2 py-1 text-xs font-medium bg-${color}-200 text-${color}-800 rounded-full flex-shrink-0`}>{label}</span>
                                            </div>
                                        );
                                    })
                                ) : (
